const READS = new Set([
  'pooling_client_runtime','pooling_actor_runtime','pooling_test_status','pooling_test_scenario','pooling_development_context','pooling_coach_sessions',
...
export function poolingReadFailure(name,error) {
  ...
  if (error?.message === 'forbidden') return {code:'forbidden',message:'This signed-in account cannot access this client. Return to Clients and choose a record owned by your sign-in. No change was submitted by this read.'}
