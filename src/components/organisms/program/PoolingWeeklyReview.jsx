...
export default function PoolingWeeklyReview({clientId,context,workspace,drafts,online,onRefresh}){
 ...
 return <section className="card" aria-labelledby="weekly-review-title"><h2 id="weekly-review-title" tabIndex={-1}>Constrained weekly plan</h2>
  ...
  <p className="pooling-next-step">Prepare two fictional weekly slots in Test setup first. Choose their published release and weekly policy, enter the prepared start date, select both current drafts and explicitly confirm support for each. Save the weekly review; its separate approval controls open below.</p>
