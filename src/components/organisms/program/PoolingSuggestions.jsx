...
export default function PoolingSuggestions({clientId,context,drafts,workspace,online,onRefresh}){
 ...
 return <section className="card"><h2>Generate a pool draft or compatible swap</h2><p>Uses the selected session's confirmed sources and published exercise/dose revisions. Required gaps stay visible; pins, convenience and preferences cannot override exclusions.</p>
