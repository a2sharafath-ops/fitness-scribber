...
export default function PoolingTestPage(){
 ...
 return <div className="pooling-workspace">
  ...
  <section className="card"><h2>Test scope and availability</h2>
  ...
  {clientId&&<section className="card"><h2>Prepare an explicit software scenario</h2>
  ...
  <section className="card"><h2>Coach walkthrough</h2><ol>
