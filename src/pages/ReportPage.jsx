      ...
      <div id="reportBody">
        <div className="flex between" style={{ borderBottom: '2px solid var(--border)', paddingBottom: 12, marginBottom: 16 }}>
          <div><h1 style={{ fontSize: 22 }}>{c.name} — Athlete Report</h1>
            <div className="muted">{db.settings.businessName || 'FitScribe'} · {db.settings.trainerName || ''} · {fmtDate(today)}</div></div>
        ...
        <p className="muted" style={{ fontSize: 11, marginTop: 20 }}>Generated by FitScribe on {fmtDate(today)}. For coaching use.</p>
      </div>
    </>
  )
}
