...
|---|---|---|---|
| TC-001 | L | context.test.js; sources.test.js | Exact empty legacy movement dataset still needs accepted-case execution. |
| TC-002 | L | context.test.js; sources.test.js | Untouched lifestyle and daily-slider combinations not all replayed through the hosted UI. |
...
| TC-020 | L | sources.test.js; selection.test.js | No unconfirmed load authority; exact default one-rep legacy import still needs acceptance fixture. |
...
| TC-045 | L | selection.test.js; sources.test.js | Session-specific inventory required; complete gym-to-hotel/assistance scenario remains. |
...
| R2-T02 | L | context.test.js; sources.test.js | No scale/default authority; exact lifestyle/slider UI combination remains. |
...
| R3-T04 | L | sources.test.js; selection.test.js | Unconfirmed method rejected; exact one-rep legacy progression fixture remains. |
